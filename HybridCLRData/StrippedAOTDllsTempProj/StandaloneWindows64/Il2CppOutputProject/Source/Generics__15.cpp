...
IL_0009:
	...
	try
	{
		...
		try
		{
			Hash128_t93367F504B687578F893CDBCD13FB95AC8A87A40 L_3 = V_0;
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_Add_mB8CB90D9FFC33504630529B6C99891A5ED4FAA1C(__this, L_3, ((*(uint32_t*)((uint32_t*)(uint32_t*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 15))))), il2cpp_rgctx_method(method->klass->rgctx_data, 21));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
